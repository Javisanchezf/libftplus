...
#    Updated: 2023/03/31 20:40:04 by javiersa         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
git: fclean gitignore
	@git add *
	@echo "$(YELLOW)Git:$(BOLD) Adding all archives.$(DEFAULT)"
	@git commit -m "Little changes"
	@echo "$(CYAN)Git:$(BOLD) Commit this changes with "Little changes".$(DEFAULT)"
	@git push
	@echo "$(GREEN)Git:$(BOLD) Pushing all changes.$(DEFAULT)"
gitignore:
	@echo ".*\n*.out\n*.o\n*.a">.gitignore
